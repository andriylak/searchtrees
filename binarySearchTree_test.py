...
class TestTreeNode(unittest.TestCase):
    ...
    def test_previous(self):
        ...
        self.assertEqual(self.tree.previous(4), TreeNode(3, "A", TreeNode(1), TreeNode(4)))  
        self.assertEqual(self.tree.previous(10), TreeNode(9))                        #the key 10 is not in the tree
    ...
    def test_next(self):
        ...
        self.assertEqual(self.tree.next(0), TreeNode(1))                             #the key 0 is not in the tree

    def test_kth_element(self):
        self.assertIsNone(self.empty_tree.kthLargestElement(10))
        self.assertEqual(self.single_node.kthLargestElement(1), self.single_node)
        self.assertEqual(self.tree.kthLargestElement(3), self.tree) 

    def test_element_access(self):
        self.assertIsNone(self.empty_tree.elementAccess(10))
        self.assertEqual(self.single_node.elementAccess(1), "A")
        self.assertIsNone(self.single_node.elementAccess(10))           #the key is not in the tree
